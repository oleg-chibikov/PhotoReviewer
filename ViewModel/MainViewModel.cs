...
public partial class MainViewModel : IDisposable
{
    ...
    readonly IWindowFactory<GalleryWindow> _galleryWindowFactory;
    ...
    public MainViewModel(
        ...
        IWindowFactory<GalleryWindow> galleryWindowFactory)
    {
        ...
        _galleryWindowFactory = galleryWindowFactory ?? throw new ArgumentNullException(nameof(galleryWindowFactory));
        ...
        ShowMemoriesCommand = new AsyncCorrelationCommand(commandManager, ShowMemoriesAsync);
        ...
        {
            SetDirectoryPathAsync(directoryPath, needChange: false);
        }
    }
    ...
    public ICommand ShowMemoriesCommand { get; }
    ...
    async Task ShowMemoriesAsync()
    {
        await _galleryWindowFactory.ShowWindowAsync(default).ConfigureAwait(false);
    }
...
#pragma warning restore IDE0051
    {
        // update visible items without scrolling
        _loadMetadataForVisibleItems?.Invoke(null);
    }
}
