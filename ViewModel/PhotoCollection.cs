...
#pragma warning restore CA1863 // Use 'CompositeFormat'
        ...
        await StartLongOperationAsync(
            ...
            LoadPhotos,
            cancelCurrent: true).ConfigureAwait(true); // new operation cancels previous one
        return;
    ...
    public async Task ShiftDateAsync(Photo[] photos, TimeSpan shiftBy, bool plus, bool renameToDate)
    {
        ...
        await StartLongOperationAsync(
                ...
                async cancellationToken =>
                {
                    ...
                    var notificationSuppressor = _directoryWatcher.SuppressNotification();
                    ...
                    try
                    {
                        ...
                        var exifToolPatterns = photos.Select(x => x.FileLocation)
                            ...
                            .ToArray();
                        await _exifTool.ShiftDateAsync(shiftBy, plus, exifToolPatterns, backup: false, cancellationToken).ConfigureAwait(false);
                    }
                    ...
                    finally
                    {
                        ...
                        notificationSuppressor.Dispose();
                    }
                },
                cancelCurrent: false)
    ...
    static void ResetTempPhotoMarkers(IEnumerable<Photo> photos)
    {
        foreach (var photo in photos)
        {
